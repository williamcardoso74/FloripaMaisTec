...
async function updateEnfermeiro(request, response) {
  try {
    ...
    enfermeiroInTable.nome_completo = enfermeiroInBody.nome_completo || enfermeiroInTable.nome_completo;
    enfermeiroInTable.genero = enfermeiroInBody.genero || enfermeiroInTable.genero;
    enfermeiroInTable.data_nascimento = enfermeiroInBody.data_nascimento || enfermeiroInTable.data_nascimento;
    enfermeiroInTable.cpf = enfermeiroInBody.cpf || enfermeiroInTable.cpf;
    enfermeiroInTable.telefone = enfermeiroInBody.telefone || enfermeiroInTable.telefone;
    enfermeiroInTable.instituicao_ensino_formacao = enfermeiroInBody.instituicao_ensino_formacao || enfermeiroInTable.instituicao_ensino_formacao;
    enfermeiroInTable.cadastro_cofen_uf = enfermeiroInBody.cadastro_cofen_uf || enfermeiroInTable.cadastro_cofen_uf;
